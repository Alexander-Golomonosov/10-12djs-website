...
const items = [
  ...
  },
  {
    ...
    price: "2 990 ₽",
    description: "УТИЛИТАРНЫЙ БОКС ВЫЖИВАНИЯ ДЛЯ РЕЙВЕРОВ: БЕРУШИ, ЭЛЕКТРОЛИТЫ, ТЕЗЕР ДЛЯ СМАРТФОНА, ПОВЕРБАНК 10 000 МАЧ, ВЕЕР, МАСКА ДЛЯ СНА, КАПЛИ ДЛЯ ГЛАЗ, ДОЖДЕВИК.",
    image: "/merch-suitcase.jpg",
    tags: ["НАБОР", "ТУСОВКА", "HARD UNIT"],
  },
  {
