...
const events: EventItem[] = [
  ...
  },
  {
    ...
    dateStart: new Date("2026-08-14"),
    poster: "/poster-rap-sandwich-14.png",
    posterAlt: "RAP SANDWICH",
    posterWidth: 1536,
    posterHeight: 1920,
    venue: "НЕКРАСОВА 26",
    location: "НЕКРАСОВА 26, СПБ",
    time: "16:00",
    artists: [
      { name: "DEADRIPPLE" },
      { name: "DJ ENDE" },
  ...
  },
  {
    ...
    poster: "/upcoming-lupus-fest.png",
